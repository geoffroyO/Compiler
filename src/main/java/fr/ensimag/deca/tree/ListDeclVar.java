...
public class ListDeclVar extends TreeList<AbstractDeclVar> {
	 ...
	 * @param localEnv
	 *            its "parentEnvironment" corresponds to "env_exp_sup" attribute in
	 *            precondition, its "current" dictionary corresponds to the
	 *            "env_exp" attribute in postcondition, its "current" dictionary
	 *            corresponds to the "env_exp_r" attribute
	 * @param currentClass
